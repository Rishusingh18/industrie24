...
export default function SignupPage() {
    return (
        <div className="flex min-h-screen w-full bg-gray-50 dark:bg-black relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full bg-blue-500/10 blur-[100px] pointer-events-none" />
                    ...
                    <div className="p-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Join us to access exclusive industrial products
                            </p>
                        </div>
